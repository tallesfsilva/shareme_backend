...
import { PinType, PostedByType } from "../types";
...
router.post('/create', async function (req: Request, res : Response, next){
...
router.post('/delete/:id', async function (req: Request, res : Response){
...
router.get('/more', async (req: Request, res:Response)=>{
...
router.post('/comment', async function (req: Request, res : Response){
...
router.get('/detail/:id', async function (req: Request, res : Response){
